...
public:
	...
	FileRead(int fd, const std::string& display_name);  // Android FD constructor
	...
	int fd_ = -1;  // original fd (Android only, for avformat_open_input)
...
public:
	...
	FileWrite(int fd);  // Android FD constructor
	~FileWrite();
